...
def set_security_headers(response):
    ...
    response.headers['Content-Security-Policy'] = "default-src 'self' https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.socket.io https:; connect-src 'self' http: https: ws: wss: https://cdn.socket.io; style-src 'self' 'unsafe-inline'; img-src 'self' data:; frame-src 'self' http: https:;"
    return response
